...
enum CompanionScreenCaptureUtility {
    ...
    ///
    /// `maxDimension` caps the screenshot's longest edge. The 1280 default is
    /// tuned for the voice flow (context + pointing); callers that need the
    /// model to READ small on-screen text (e.g. workflow source extraction)
