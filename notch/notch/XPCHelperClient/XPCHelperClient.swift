...
final class XPCHelperClient: NSObject {
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<NotchXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<NotchXPCHelperProtocol>(
            connection: conn,
            remoteInterface: NotchXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<NotchXPCHelperProtocol>? {
        remoteService
    }
